...
<body>
  ...
  <div class="container">
    <center><a href="./index.html"><img src="img/logo.jpeg" alt="" style="margin-top: 80px; width: 50%;"></a></center>
  ...
  function validate()
{
 ...
 if( name.value == "" )
 {
  error = " <font color='red'>!Requires Name.</font> ";
  document.getElementById( "nameerror" ).innerHTML = error;
  return false;
 }
 if(name.value.length <= 2) 
{
   error = " <font color='red'>Enter charecters above 2 length</font> ";
...
if(!isNaN(name.value)) 
{
   error = " <font color='red'>!please only alphabets or charecters allowed</font> ";
